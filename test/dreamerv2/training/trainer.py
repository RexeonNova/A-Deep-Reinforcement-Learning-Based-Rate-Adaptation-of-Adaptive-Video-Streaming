...
from dreamerv2.utils.buffer import TransitionBuffer, EpisodicBuffer
...
class Trainer(object):
    ...
    def _model_initialize(self, config):
        ...
        #self.buffer = EpisodicBuffer(config.capacity, obs_shape, action_size, config.seq_len, config.batch_size, config.obs_dtype, config.action_dtype)
