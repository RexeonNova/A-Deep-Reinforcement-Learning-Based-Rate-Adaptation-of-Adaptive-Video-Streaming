...
class MinAtarConfig():
    ...
    rssm_info: Dict = field(default_factory=lambda:{'deter_size':200, 'stoch_size':256, 'class_size':25, 'category_size':25, 'min_std':0.1})
    ...
    slow_target_update: int = 120 #*2 train steps
